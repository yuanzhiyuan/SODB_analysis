...
def main(args):
    ...
    if not os.path.exists(generated_data_fold):
        os.makedirs(generated_data_fold)
    adata_h5 = sc.read_h5ad(f'{data_fold}/V1_Mouse_Brain_Sagittal_Posterior.h5ad')
    print(adata_h5)
    #count = adata_h5.X 
...
if __name__ == "__main__":
    ...
    parser.add_argument( '--data_name', type=str, default='V1_Mouse_Brain_Sagittal_Posterior', help='The name of dataset')
